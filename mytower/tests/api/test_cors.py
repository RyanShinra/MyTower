...
class TestCORSDefaultConfiguration:
    ...
    def test_wildcard_origins_by_default(self, clean_env, test_client_factory) -> None:
    ...
    def test_credentials_disabled_with_wildcard(self, clean_env, test_client_factory) -> None:
    ...
    def test_all_methods_allowed(self, clean_env, test_client_factory) -> None:
    ...
    def test_all_headers_allowed(self, clean_env, test_client_factory) -> None:
...
class TestCORSEnvironmentVariableHandling:
    ...
    def test_single_origin(self, clean_env, test_client_factory) -> None:
    ...
    def test_multiple_origins(self, clean_env, test_client_factory) -> None:
    ...
    def test_whitespace_stripping(self, clean_env, test_client_factory) -> None:
    ...
    def test_credentials_enabled_with_specific_origins(self, clean_env, test_client_factory) -> None:
    ...
    def test_wildcard_in_list_disables_credentials(self, clean_env, test_client_factory) -> None:
...
class TestCORSSecurityCompliance:
    ...
    def test_wildcard_with_credentials_not_allowed(self, clean_env, test_client_factory) -> None:
        """
    ...
    def test_production_configuration(self, clean_env, test_client_factory) -> None:
...
class TestCORSEndpointCoverage:
    ...
    def test_cors_on_root_endpoint(self, clean_env, test_client_factory) -> None:
    ...
    def test_cors_on_health_endpoint(self, clean_env, test_client_factory) -> None:
    ...
    def test_cors_on_graphql_endpoint(self, clean_env, test_client_factory) -> None:
