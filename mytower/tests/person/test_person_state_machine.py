...
class TestPersonStateMachine:
    ...
    def test_update_waiting_for_elevator_increments_time(self, person_with_floor: Person) -> None:
        ...
        person_with_floor.testing_set_wait_time(5.0)
        initial_wait_time: float = person_with_floor.testing_get_wait_time()
        
        person_with_floor.update(2.5)
        
        assert person_with_floor.testing_get_wait_time() == initial_wait_time + 2.5
