...
class TestPersonWaitingBehavior:
    ...
    def test_idle_timeout_prevents_constant_checking(self, person_with_floor: Person, mock_building_with_floor: MagicMock) -> None:
        ...
        person_with_floor.update_idle(6.0)
    ...
    def test_waiting_time_affects_anger_color(self, person_with_floor: Person, mock_game_config: MagicMock) -> None:
        ...
        person_with_floor.testing_set_wait_time(0.0)
        red_calm = person_with_floor.draw_color_red
        ...
        red_angry = person_with_floor.draw_color_red
